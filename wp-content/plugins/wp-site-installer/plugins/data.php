...
function get_plugins_data() {
    $plugins = array ( 
            array ( 
                'name' => 'WP Super Cache', 'folder' => 'wp-super-cache', 'file' => 'wp-cache.php', 'activate' => 1,
                'local' => 1, 'online' => 1,
                    'configure' => 1, 
                    'settings' => array (
            ...
            array ( 
                'name' => 'Autoptimize', 'folder' => 'autoptimize', 'file' => 'autoptimize.php', 'activate' => 1, 
                'local' => 1, 'online' => 1,
                    'configure' => 1, 
                    'settings' => array (
                ...
                array ( 
                'name' => 'WP Optimization', 'folder' => 'wp-optimization', 'file' => 'plugin.php', 'activate' => 1,
                'local' => 1, 'online' => 1,
                    'configure' => 0, 
                    'settings' => array (
                ...
                array ( 
                'name' => 'Sucuri Scanner', 'folder' => 'sucuri-scanner', 'file' => 'sucuri.php', 'activate' => 1, 
                'local' => 0, 'online' => 1,
                    'configure' => 1, 
                    'settings' => array (
                ...
                array ( 
                'name' => 'BackUpWordPress', 'folder' => 'backupwordpress', 'file' => 'backupwordpress.php', 'activate' => 1, 
                'local' => 1, 'online' => 1,
                    'configure' => 0, 
                    'settings' => array (
                            array ( 'option_name' => '', 'option_value' => '', 'set' => 0 ),
                ...
                array ( 
                'name' => 'WP Ice Age', 'folder' => 'wp-ice-age', 'file' => 'plugin.php', 'activate' => 1, 
                'local' => 1, 'online' => 1,
                    'configure' => 0, 
                    'settings' => array (
                            array ( 'option_name' => '', 'option_value' => '', 'set' => 0 ),
